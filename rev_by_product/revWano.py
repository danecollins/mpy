...
### returns need to be negative
	...
	if ((item[0:3] == 'MWO' or item[0:3] == 'APL' or item[0:3] == 'UPG') and void == 'Normal'):
	...
	elif ((item[0:3] == 'ANO') and void == 'Normal'):
		#print "ANO product = %s" % item
		ano = ano + lineType*float(ep1)
	elif ((item[0:3] == 'XEM' or item[0:3] == 'ANA' or item[0:3] == 'ACE') and void == 'Normal'):
		#print "XEM product = %s" % item
		xem = xem + lineType*float(ep1)
	elif ((item[0:3] == 'HSP' or item[0:3]=='TSW' or item[0:3]=='FIL' or item[0:3]=='MOD' or item[0:3]=='NXG' or item[0:3]=='PTD' or item[0:3]=='WIQ' or item[0:3]=='ACS') and void == 'Normal'):
